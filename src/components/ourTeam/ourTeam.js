        ...
        <div className="container-fluid">
            ...
            <div className="row">
                ...
                <div className="col-md-12 outer">
                    ...
                    <div className="row">
                        {/* <div className=""> */}
                        <div className="col-md-3 col-xs-12 col-sm-12 E_Team">Executive Team</div>
                        <div className=" col-md-6 col-xs-12 col-sm-12 success"> <p>
                        ...
                        <div className="col-md-2 col-xs-12 col-sm-12 BtnA"><button>View All</button></div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-3 ">
                            <img className="img1" src={require('./member1.jpg')} />
                        </div>
                        <div className="col-md-3 ">
                            <img className="img1" src={require('./member2.jpg')} />

                        </div>
                        <div className="col-md-3 ">
                            <img className="img1" src={require('./member3.jpg')} />

                        </div>
                        <div className="col-md-3 ">
                            <img className="img1" src={require('./member4.jpg')} />
